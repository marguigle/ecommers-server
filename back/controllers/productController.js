...
export const syncExternalProduct = asyncHandler(async (req, res) => {
  const { externalId, title, price, description, image, category } = req.body;

  // Buscar si ya existe un producto con ese externalId
